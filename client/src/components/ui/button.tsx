  ...
  " hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive-foreground border border-destructive-border shadow-sm hover:brightness-105",
        outline:
          "border border-border bg-background/90 text-foreground shadow-xs hover:bg-accent/60 active:shadow-none",
        secondary: "border border-secondary-border bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80",
        // Add a transparent border so that when someone toggles a border on later, it doesn't shift layout/size.
        ghost: "border border-transparent text-foreground hover:bg-accent/60",
      },
